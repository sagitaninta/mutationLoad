...
with open(load_file, "r") as file:
    ...
    for line in bed:
        hap=line[6] # haploid allele
        anc=line[3] # ancestral allele as inferred from prev pipeline
        phylop=float(line[4]) 
        phastcons=float(line[5])
...
load_out_file = out_file + "_phy_pha_spHapload.txt"
...
sift_out_file = out_file + "_sift_spHapload.txt"
